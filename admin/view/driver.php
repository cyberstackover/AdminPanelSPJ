...
?>
<form name="form1" method="post" action="<?php if($halw[0] !="" && $halw[1]!=""){ echo "admin/controller/driver.php?req=edit&$halw[0]=$halw[1]"; }else{ echo "admin/controller/driver.php?req=save"; } ?>" class="form">
...
<table width="100%" border="0" cellspacing="2" cellpadding="4" class="table">
  ...
  $key = "where name like '%".$_POST['keyword']."%'"; 
    ...
    $a = mysql_query("select * from driver ".$key." order by uid asc");
	$i = 1;
    ...
    <tr class="tr">
      ...
      <td class="td">
    <a href="javascript:void(0)" onclick="confirm_delete(<?php echo $b['uid'] ?>,'admin/controller/driver.php?req=delete&uid=')"><div class="trash"></div></a>
      <a href="admin.php?page=admin/view/driver&uid=<?php echo $b['uid'] ?>"><div class="edit"></div></a>      </td>
    </tr>
    <?php
		}else{
	?>
